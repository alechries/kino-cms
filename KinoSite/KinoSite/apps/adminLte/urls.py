...
urlpatterns = [
    ...
    path('banner/upper', views.upper_banner, name='admin_upper_banner'),
    path('banner/main', views.main_banner, name='admin_main_banner'),
    path('banner/background', views.background_banner, name='admin_background_banner'),
