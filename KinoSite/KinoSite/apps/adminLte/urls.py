...
urlpatterns = [
    ...
    path('banner/list', views.banner, name='admin_banner_list'),
    path('main_slide/form', views.main_slide_form, name='admin_main_slide_form'),
    path('main_slide/form/<int:pk>', views.main_slide_form, name='admin_main_slide_form_edit'),
