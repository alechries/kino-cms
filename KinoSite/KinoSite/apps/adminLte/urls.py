...
urlpatterns = [
    ...
    path('cinema/form', views.film_edit_form, name='admin_cinema_form'),
    path('cinema/form/<int:pk>', views.film_edit_form, name='admin_cinema_edit'),
    path('cinema/delete/<int:pk>', views.film_delete, name='admin_cinema_delete'),
    path('hall/page', views.hall_page, name='admin_hall_page'),
    path('hall/form', views.film_edit_form, name='admin_hall_form'),
    path('hall/form/<int:pk>', views.film_edit_form, name='admin_hall_edit'),
    path('hall/delete/<int:pk>', views.film_delete, name='admin_hall_delete'),
